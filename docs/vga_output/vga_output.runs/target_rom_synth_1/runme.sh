...
HD_PWD='C:/Users/u2012758/OneDrive - University of Warwick/Work/es2e3/coursework/vga_output/vga_output.runs/target_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log target_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source target_rom.tcl
